        ...
        <td class="align-middle">
            <div class="dropdown">
                ...
                <div class="dropdown-menu">
                    ...
                    <a data-id="{{ $data->id_transaksi }}" class="dropdown-item hapus_transaksi" href="#"><i
                            class="fas fa-trash"></i> Hapus</a>
                    <form id="delete_transaksi_{{ $data->id_transaksi }}" action="{{ route('transaksi.delete', $data->id_transaksi) }}"
