export default function profile() {
    $(document).ready(function () {
        // Menggunakan .off("click", ".btn-profile").on("click", ".btn-profile") untuk mencegah event duplicate.
        $(document).off("click", ".profile-action").on("click", ".profile-action", function () {
            let id = $(this).data("id");
